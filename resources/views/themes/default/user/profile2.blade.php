                        ...
                        <div class="col-lg-3">
                            @if ($profile->profile_img)
                                ...
                                <img src="{{ route('imagecache', [ 'template'=>'medium','filename' => $profile->fiName() ]) }}" alt=""
                                    class="img-fluid" style="border:3px solid gray ;{{$profile->profile_public == 1 ? " ":"filter: blur(5px);" }}">
                            @else
                                ...
                                <div class="row py-3">
                                    ...
                                    <div class="col-md-6">
                                      ...
                                      <div class="profile-info-grid">
                                            ...
                                            <div>
                                                : {{ $profile->mobile }}(only admin seen)
                                            </div>
                                        </div>
                                ...
                                <div class="row py-3">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="profile-info-grid">
                                            ...
                                            <div>
                                                : {{ $profile->guardian_mobile }}(only Admin Seen)
                                            </div>
                                        </div>
                                        @else
                                        @if(auth()->user()->checkContactUserPack($profile->id) > 0 )
